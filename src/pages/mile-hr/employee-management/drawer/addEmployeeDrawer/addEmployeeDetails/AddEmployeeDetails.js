...
function AddEmployeeDetails({handleDrawerClosed}) {
  ...
  return (
    <div className="addEmployeeDetails">
        ...
        {isAccordionOpen_4 && (
          <div className="accordionContainerBody">
            ...
            <div className="grid" style={{ margin: '20px 0' }}>
              ...
              <div className="gridItems">
                <label style={{ color: '#545454' }}>Mahindra Dealer Name</label>
                <Dropdown
                  items={dealerName}
                  // selectedText={values.gender}
                  // handleChange={(value) => handleChange("gender")(value)}
              ...
              <table>
                ...
                <tbody>
                  {tbody?.map((ele, index) => {
                    return (
                      <tr key={index}>
                        <td style={{borderColor:theme === "light" ? "#E6E6E6" : "#E6E6E6"}}>{index+1}</td>
                        <td style={{borderColor:theme === "light" ? "#E6E6E6" : "#E6E6E6"}}>
                          {ele.organisationname ? ele.organisationname : '-'}
                        </td>
                        <td style={{borderColor:theme === "light" ? "#E6E6E6" : "#E6E6E6"}}>{ele.dealer ? ele.dealer : '-'}</td>
                        <td style={{borderColor:theme === "light" ? "#E6E6E6" : "#E6E6E6"}}>{ele.location ? ele.location : '-'}</td>
                        <td style={{borderColor:theme === "light" ? "#E6E6E6" : "#E6E6E6"}}>{ele.emp_role ? ele.emp_role : '-'}</td>
                        <td style={{borderColor:theme === "light" ? "#E6E6E6" : "#E6E6E6"}}>
                          {ele.capabilityLevel ? ele.capabilityLevel : '-'}
                        </td>
                        <td style={{borderColor:theme === "light" ? "#E6E6E6" : "#E6E6E6"}}>{ele.fromDate ? ele.fromDate : '-'}</td>
                        <td style={{borderColor:theme === "light" ? "#E6E6E6" : "#E6E6E6"}}>{ele.toDate ? ele.toDate : '-'}</td>
                        <td style={{borderColor:theme === "light" ? "#E6E6E6" : "#E6E6E6"}}>
      ...
      >
        {/* left btns */}
        <button className="btns outlineBtn" type="button" onClick={()=>handleDrawerClosed()}>
          Cancel
        </button>
        {/* right btns */}
